...
namespace"sorceress"{
	class "Material"{
		...
		:body(function(self)
			...
			self.mat.body1:SetColorHSV(355,255,1.100)
			self.mat.body1:SetEffect(0,0,0,0)

			self.mat.body2:SetColorHSV(355,100,100.100)
			self.mat.body2:SetEffect(0,0,15,15)

			self.mat.body3:SetColorHSV(100,0,0.0)
			self.mat.body3:SetEffect(355,140,15,15)

			self.mat.glass:SetColorHSV(0,0,0.2)
			self.mat.glass:SetEffect(8,0,0,0)

			self.mat.wheel:SetColorHSV(255,0,0.4)
			...
			self.mat.brakeCaliper:SetColorHSV(0,1,100.100)
