...
namespace"sorceress"{
	class "Wing"{
		...
		method"Z"
		:body(function(self)
			self.val.fl=180-(32+7+self.sensors.core.lvz*0.22)*(1+self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
			self.val.fr=180-(32+7+self.sensors.core.lvz*0.22)*(1-self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)   - 67.5 *self.inputs.normalBrake- 0*self.inputs.sideBrake
			self.val.rl=0-(27+8+self.sensors.core.lvz*0.22)*(1+self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
			self.val.rr=0-(27+8+self.sensors.core.lvz*0.22)*(1-self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
